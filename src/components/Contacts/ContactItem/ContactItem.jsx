...
const ContactItem = () => {
  return (
    ...
    <h3 className='border-solid rounded-xl bg-violet-300 text-xl mt-3 self-center w-48 text-center h-8 '>Contact</h3>
   ...
   <MdAddAPhoto className='w-12 h-12'/>
      ...
      //  key={contact.id} 
       className='w-8/12'>
        <ContactInfo><GoPerson/>Aian</ContactInfo>
        <ContactInfo><BsFillTelephoneFill/>0707630993</ContactInfo>
        <ContactInfo><MdOutlineAlternateEmail/>aya24111989@gmail.com</ContactInfo>
      </div>
       <div>
